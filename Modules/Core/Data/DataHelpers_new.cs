...
case "AnneX": 
return await DS.db.GetAllAsync<AnneX>(a => true);     
...
case "Vehicule": 
return await DS.db.GetAllAsync<Vehicule>(a => true);     
...
case "AnneX": 
return DS.db.GetAll<AnneX>(a => true).Where(a => strict == true ?  
a.GetType().GetProperty(field).GetValue(a, null)?.ToString() == value
:
a.GetType().GetProperty(field).GetValue(a, null).ToString().Contains(value)
 );
...
case "Vehicule": 
return DS.db.GetAll<Vehicule>(a => true).Where(a => strict == true ?  
a.GetType().GetProperty(field).GetValue(a, null)?.ToString() == value
:
a.GetType().GetProperty(field).GetValue(a, null).ToString().Contains(value)
 );
...
case "AnneX": 
return DS.db.GetAll<AnneX>(a => true);     
...
case "Vehicule": 
return DS.db.GetAll<Vehicule>(a => true);     
